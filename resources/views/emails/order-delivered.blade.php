    ...
    <div style="max-width: 600px; margin: 40px auto; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px;">
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                <h2 style="color: #f97316; margin: 0 0 10px 0; font-size: 28px; font-weight: 600;">Order Delivered!</h2>
                <p style="color: #666; margin: 0; font-size: 16px;">Great news! Your order has been delivered successfully.</p>
            </div>
            ...
            <div style="background: linear-gradient(135deg, #fff7ed 0%, #ffedd5 100%); padding: 30px; border-radius: 15px; margin: 30px 0; border: 2px solid #f97316;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tr>
                        <td style="padding: 8px 0; color: #666; font-size: 14px; font-weight: 500;">Delivery Address:</td>
                        <td style="padding: 8px 0; color: #333; font-size: 14px; font-weight: 600; text-align: right;">{{ $order->delivery_address }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; color: #666; font-size: 14px; font-weight: 500;">Delivered on:</td>
            ...
            <div style="margin: 30px 0;">
                <h3 style="color: #333; margin: 0 0 20px 0; font-size: 20px; font-weight: 600;">Your Order</h3>
                @php
            ...
            <div style="background: #ecfdf5; border-left: 4px solid #10b981; padding: 20px; margin: 30px 0; border-radius: 8px;">
                ...
                <p style="margin: 0; color: #065f46; font-size: 14px; line-height: 1.5; text-align: center;">
                    We hope you enjoyed your meal. We look forward to serving you again soon!
                </p>
            </div>
