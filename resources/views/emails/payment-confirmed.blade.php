    ...
    <div style="max-width: 600px; margin: 40px auto; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px;">
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                <h2 style="color: #f97316; margin: 0 0 10px 0; font-size: 28px; font-weight: 600;">Payment Confirmed!</h2>
                <p style="color: #666; margin: 0; font-size: 16px;">Your payment has been successfully processed.</p>
            </div>
            ...
            <div style="background: linear-gradient(135deg, #fff7ed 0%, #ffedd5 100%); padding: 30px; border-radius: 15px; margin: 30px 0; border: 2px solid #f97316;">
                <h3 style="color: #ea580c; margin: 0 0 20px 0; font-size: 20px; font-weight: 600; text-align: center;">Payment Details</h3>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #10b981; font-size: 14px; font-weight: 700; text-align: right;">Confirmed</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; color: #666; font-size: 14px; font-weight: 500;">Amount Paid:</td>
                        <td style="padding: 8px 0; color: #f97316; font-size: 16px; font-weight: 700; text-align: right;">KES {{ number_format($order->total, 2) }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; color: #666; font-size: 14px; font-weight: 500;">Confirmed on:</td>
                        <td style="padding: 8px 0; color: #333; font-size: 14px; font-weight: 600; text-align: right;">{{ now()->format('M d, Y - H:i') }}</td>
                    </tr>
                </table>
            </div>
            ...
            <div style="margin: 30px 0;">
                <h3 style="color: #333; margin: 0 0 20px 0; font-size: 20px; font-weight: 600;">Order Summary</h3>
                @php
            ...
            <div style="background: #f9fafb; padding: 25px; border-radius: 15px; margin: 30px 0;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="border-top: 2px solid #f97316;">
                        <td style="padding: 15px 0 10px 0; color: #f97316; font-size: 18px; font-weight: 700;">Total Paid:</td>
            ...
            <div style="background: #ecfdf5; border-left: 4px solid #10b981; padding: 20px; margin: 30px 0; border-radius: 8px;">
                <p style="margin: 0 0 10px 0; color: #065f46; font-size: 16px; font-weight: 600; text-align: center;">
                    Thank you for shopping with Cafe Delight!
                </p>
                <p style="margin: 0; color: #065f46; font-size: 14px; line-height: 1.5; text-align: center;">
                    We appreciate your business. Your payment has been successfully processed and confirmed.
                </p>
            </div>
