    ...
    <div style="max-width: 600px; margin: 40px auto; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px;">
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                <h2 style="color: #f97316; margin: 0 0 10px 0; font-size: 28px; font-weight: 600;">New Order Received!</h2>
                <p style="color: #666; margin: 0; font-size: 16px;">A customer has just placed a new order.</p>
            </div>
            ...
            <div style="background: linear-gradient(135deg, #fff7ed 0%, #ffedd5 100%); padding: 30px; border-radius: 15px; margin: 30px 0; border: 2px solid #f97316;">
                <h3 style="color: #ea580c; margin: 0 0 20px 0; font-size: 20px; font-weight: 600; text-align: center;">Order Information</h3>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tr>
                        <td style="padding: 8px 0; color: #666; font-size: 14px; font-weight: 500;">Total Amount:</td>
                        <td style="padding: 8px 0; color: #f97316; font-size: 16px; font-weight: 700; text-align: right;">KES {{ number_format($order->total, 2) }}</td>
                    </tr>
                    <tr>
                ...
                <div style="padding: 15px 0; border-top: 1px dashed #fdba74; margin-top: 15px;">
                    <p style="color: #666; font-size: 13px; margin: 0 0 5px 0;"><strong>Customer Name:</strong></p>
                    <p style="color: #333; font-size: 15px; font-weight: 600; margin: 0 0 10px 0;">{{ $order->user->name }}</p>
                    <p style="color: #666; font-size: 13px; margin: 0 0 5px 0;"><strong>Customer Email:</strong></p>
                    <p style="color: #333; font-size: 14px; margin: 0 0 10px 0;">{{ $order->user->email }}</p>
                    <p style="color: #666; font-size: 13px; margin: 0 0 5px 0;"><strong>Phone:</strong></p>
                    <p style="color: #333; font-size: 14px; margin: 0 0 10px 0;">{{ $order->phone }}</p>
                    <p style="color: #666; font-size: 13px; margin: 0 0 5px 0;"><strong>Delivery Address:</strong></p>
                    <p style="color: #333; font-size: 14px; margin: 0;">{{ $order->delivery_address }}</p>
                </div>
            </div>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="{{ url('/admin/orders') }}" style="display: inline-block; background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 50px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 15px rgba(249, 115, 22, 0.4);">
            ...
            <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin: 30px 0; border-radius: 8px;">
                <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.5;">
                    <strong>⚡ Action Required:</strong> Please review and process this order promptly to ensure timely delivery.
                </p>
            </div>
        </div>
        ...
        <div style="background: #1f2937; padding: 30px; text-align: center;">
            ...
            <p style="color: rgba(255,255,255,0.5); margin: 0; font-size: 12px;">
                Admin Notification - Cafe Delight Management System
            </p>
        </div>
    </div>
</body>
