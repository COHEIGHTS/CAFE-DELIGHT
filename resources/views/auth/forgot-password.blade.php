<!DOCTYPE html>
<html lang="en" x-data="forgotPasswordPage()" :class="{ 'dark': darkMode }" x-cloak class="scroll-smooth">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>Forgot Password — Cafe Delight</title>
    ...
    <div class="mx-auto grid min-h-screen max-w-7xl items-center gap-0 px-4 py-10 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div class="relative hidden overflow-hidden rounded-l-[2.5rem] bg-gradient-to-br from-brand-500 via-brand-600 to-brand-800 p-12 text-white lg:flex lg:flex-col lg:justify-between lg:min-h-[600px]">
            ...
            <div class="relative">
                ...
                <h1 class="font-display text-4xl font-extrabold leading-tight xl:text-5xl">Forgot<br>password?</h1>
                <p class="mt-5 max-w-md text-orange-50/90">No worries! Enter your email and we'll send you a reset link to get you back into your account.</p>
                ...
                <div class="mt-8 flex items-center gap-1 text-gold">
                    ...
                    <span class="ml-2 text-sm font-semibold text-orange-50/90">Secure password recovery</span>
                </div>
            </div>

            <p class="text-sm text-orange-50/80">"Quick and easy password reset — I was back ordering in minutes." — John D.</p>
        </div>
        ...
        <div data-aos="fade-left" class="glass-strong rounded-[2.5rem] p-8 shadow-premium sm:p-10 lg:rounded-l-none lg:rounded-r-[2.5rem] lg:min-h-[600px] lg:flex lg:flex-col lg:justify-center">
            ...
            <div class="mx-auto w-full max-w-md">
                ...
                <p class="mt-2 text-ink/60 dark:text-orange-50/60">We'll send you a link to reset your password.</p>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="mt-8 space-y-5" x-on:submit="submitting = true">
                    @csrf
                    ...
                    <button type="submit" :disabled="submitting"
                        ...
                        <span x-show="!submitting" class="flex items-center gap-2">
                            Send Reset Link <i data-lucide="send" class="h-5 w-5 transition-transform group-hover:translate-x-1"></i>
                        </span>
                        <span x-show="submitting" class="flex items-center gap-2">
